...
"font-size: 16px;")
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/images/backup.jpg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionBackup.setIcon(icon6)
        self.actionLoad = QAction(MainWindow)
        self.actionLoad.setObjectName(u"actionLoad")
        icon7 = QIcon()
        icon7.addFile(u":/icons/images/load.png", QSize(), QIcon.Normal, QIcon.Off)
...
"font-size: 16px;")
        ...
        self.main_toolbar.addAction(self.actionBackup)
        self.main_toolbar.addAction(self.actionLoad)
