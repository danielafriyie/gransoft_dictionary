"""
extensions_.py is part of Gransoft Dictionary.
...
class DictDatabaseDoesNotExist(OSError):
    """dictionary database does not exist error"""
    pass


class InvalidDatabaseFile(OSError):
    """invalid databasee file provided"""
    pass
